...
extension UIDevice {
    ...
    static func iphoneType() -> String {
        ...
        if platform == "iPhone11,8" { return "iPhone X"}
        if platform == "iPhone11,2" { return "iPhone X"}
        if platform == "iPhone11,4" { return "iPhone X"}
        if platform == "iPhone11,6" { return "iPhone X"}
